      ...
      <div className="pt-16 md:pb-32 pb-8 px-2 md:px-8">
        ...
        <div className="grid grid-cols-2 grid-rows-2 gap-8">
          <section className="mt-8">
            <h3 className="font-sans font-ligh text-2xl text-center pb-12 capitalize">{dict.aboutPage.tools.subtitles[0]}</h3>
          ...
          <section className="mt-8">
            <h3 className="font-sans font-ligh text-2xl text-center pb-12 capitalize">{dict.aboutPage.tools.subtitles[1]}</h3>
            <div className="grid grid-cols-2 gap-4">
              {design.map((tool) => (
                <ToolCard key={tool.id} {...tool} />
              ))}
          ...
          <section className="mt-16 col-span-2">
            <h3 className="font-sans font-ligh text-2xl text-center pb-12 capitalize">{dict.aboutPage.tools.subtitles[2]}</h3>
          ...
          <section className="mt-16 mb-8 col-span-2 overflow-hidden">
            <h3 className="font-sans font-ligh text-2xl text-center pb-12 capitalize">{dict.aboutPage.tools.subtitles[3]}</h3>
